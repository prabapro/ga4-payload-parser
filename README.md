...
- The encoded payload uses base64 encoding after the query parameter
- The unencoded payload contains direct URL parameters
- The decoder can handle both formats automatically

# Example URL Payloads
